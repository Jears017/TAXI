...
export const EditOrder = (props) => {
    useEffect(() => {
        ordersAPI.getOrder(id).then(res => setOrder(prevState => {
            return {
                ...prevState, name: res.name,
                mobile: res.mobile, adress_from: res.adress_from,
                adress_to: res.adress_to,
                client_mobile: res.client_mobile,
                driver_id: res.driver_id,
                avto_id: res.avto_id,
                client_id: res.client_id,
                sotrudnik_id: res.sotrudnik_id,
            }
        }))
    }, [])
    ...
    const onCl = (e) => {
        ...
        ordersAPI.updateOrder(newOrder, id).then(res => res.data)
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <p><input onChange={onChangeHandler} value={order.adress_from}
                                          className="form-control-sm align-items-center" id="userName"
                                          name="adress_from"
                                          type="text"/></p>
                            </div>
                            <div>
